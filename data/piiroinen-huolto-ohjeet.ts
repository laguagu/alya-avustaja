...
ja mieto pesuaine riittävät pitämään kalusteet puhtaina. Metalli-, muovi- ja puuosat puhdistetaan kuivaksi
puristetulla pyyhkeellä. Pintakosteus poistetaan kuivalla pyyhkeellä.
...
pestä erityisesti tähän tarkoitukseen valmistetulla pesuaineilla, kuten vaahtospraylla. Vaahdon kuivuttua lika
imuroidaan pois sopivalla suulakkeella.
Jos nestettä kaatuu kalusteille, on se kuivattava mahdollisimman pian. Vesi ei välttämättä vahingoita materiaalin pintaa, mutta voi vaikuttaa sen alla olevaan runkomateriaaliin. Siksi on tärkeää poistaa pinnalla oleva
vesi, niin ettei se pääse tunkeutumaan mistään saumasta kalusteen runkoon. Mikäli lika tai tahrat ovat vaikeasti poistettavaa ainetta, kuten kahvia tai painoväriä, voidaan pintoja puhdistaa esimerkiksi alkoholipitoisilla puhdistusaineilla. Puhdistusaineen soveltuvuus on testattava aina ensin piiloon jäävälle pinnalle. Väkevä
...
teknisen prosessoinnin jälkeen. Kierrätyksen ohella uudelleen käyttäminen vähentää uuden raaka-aineen
käytön tarvetta. Uudelleen käyttö tarkoittaa jo olemassa olevien tuotteiden uudelleenkäyttöä sellaisenaan
uudessa käyttökohteessa tai tuotteen komponenttien käyttämistä uudelleen.
