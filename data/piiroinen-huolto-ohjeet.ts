...
Useimmiten vesi ja mieto pesuaine riittävät pitämään kalusteet puhtaina. Metalli-, muovi- ja puuosat puhdistetaan kuivaksi puristetulla pyyhkeellä. Pintakosteus poistetaan kuivalla pyyhkeellä.
Verhoillut pinnat imuroidaan pölystä ja irtoliasta pehmeää harjasuulaketta käyttäen. Sen jälkeen pinta pyyhitään kostealla kankaalla ja annetaan kuivua. Lopuksi nukkapinta harjataan. Kiinteästi verhoillut kalusteet voi
pestä erityisesti tähän tarkoitukseen valmistetulla pesuaineilla, kuten vaahtospraylla. 
Vaahdon kuivuttua lika imuroidaan pois sopivalla suulakkeella.
Jos nestettä kaatuu kalusteille, on se kuivattava mahdollisimman pian. Vesi ei välttämättä vahingoita materiaalin pintaa, mutta voi vaikuttaa sen alla olevaan runkomateriaaliin. Siksi on tärkeää poistaa pinnalla oleva vesi, niin ettei se pääse tunkeutumaan mistään saumasta kalusteen runkoon. 
Mikäli lika tai tahrat ovat vaikeasti poistettavaa ainetta, kuten kahvia tai painoväriä, voidaan pintoja puhdistaa esimerkiksi alkoholipitoisilla puhdistusaineilla. Puhdistusaineen soveltuvuus on testattava aina ensin piiloon jäävälle pinnalle. 
Väkevä puhdistusaine on aina laimennettava ennen käyttöä. Pintojen puhdistamiseen ei myöskään pidä käyttää hankausjauhetta eikä hankausnesteitä.
...
Kierrätyksen ohella uudelleen käyttäminen vähentää uuden raaka-aineen käytön tarvetta. 
Uudelleen käyttö tarkoittaa jo olemassa olevien tuotteiden uudelleenkäyttöä sellaisenaan uudessa käyttökohteessa tai tuotteen komponenttien käyttämistä uudelleen.
...
- Hoida kalusteista juuri sen materiaalialeille suositellulla tavalla. Etenkin puhdistusaineiden kohdalla noudata pintamateriaalikohtaisia käyttöohjeita.
- Poista kaikki nesteet ja liat kalusteiden pinnoilta mahdollisimman nopeasti.
- Noudata kankaiden kohdalla juuri kyseiselle kankaalle annettua hoito- ja puhdistusohjetta.
- Lika ja sormenjäljet näkyvät eri tavoin eri värisissä pintamateriaaleissa. Valkoinen ja vaaleat sävyt ovat luonnollisesti alttiimpia lian näkymiselle, tummissa pinnoissa näkyy puolestaan helpommin sormenjälkiä.
- Vian korjaus riippuu huonekalun materiaalista. Erilaiset materiaalit vaativat erilaisia korjausmenetelmiä ja -aineita.
...
- Ohjeen saat Piiroisen myynnistä tai suoraan kyseisen kankaan toimittajan kotisivuilta
